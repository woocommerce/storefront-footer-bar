	...
	grunt.initConfig({
		...
		makepot: {
			options: {
				...
				potHeaders: {
					'report-msgid-bugs-to': 'https://wordpress.org/support/plugin/storefront-footer-bar/',
					'language-team': 'LANGUAGE <EMAIL@ADDRESS>'
				}
			},
			frontend: {
				options: {
					potFilename: 'storefront-footer-bar.pot',
					exclude: [
						'node_modules/.*'
					]
				}
		...
		checktextdomain: {
			options:{
				text_domain: 'storefront-footer-bar',
				keywords: [
					'__:1,2d',
					'_e:1,2d',
					'_x:1,2c,3d',
		...
		compress: {
			zip: {
				options: {
					archive: './storefront-footer-bar.zip',
					mode: 'zip'
				},
				files: [{
					src: [
